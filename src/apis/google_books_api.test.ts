...
describe("Book creation", () => {
  const volumeInfo: VolumeInfo = {
    ...
    language: "en",
    previewLink:
      "http://books.google.fr/books?id=QVjPsd1UukEC&hl=&source=gbs_api",
    infoLink:
      "https://play.google.com/store/books/details?id=QVjPsd1UukEC&source=gbs_api",
    canonicalVolumeLink:
      "https://play.google.com/store/books/details?id=QVjPsd1UukEC",
  };
